...
public class TransferFund extends javax.swing.JFrame {
     ...
     * @param from
     */
    public TransferFund(double minus, double balance,String from, int acctype,MakeTransaction f) {
    ...
    private void initComponents() {
        ...
        tfTransfer.setBackground(new java.awt.Color(29, 38, 125));
        tfTransfer.setFont(new java.awt.Font("Helvetica Neue", 0, 14)); // NOI18N
        tfTransfer.setForeground(new java.awt.Color(255, 255, 255));
        tfTransfer.setCaretColor(new java.awt.Color(255, 255, 255));
        tfTransfer.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfTransferActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(tfTransfer, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
                    .addComponent(tfTransfer, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(36, 36, 36)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnTransactionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTransactionActionPerformed
        String accid = tfTransfer.getText().trim();
        PreparedStatement ps;
        ResultSet rs;
        String sql;
        if(from.equals(accid)){
        ...
        try{
           ...
           while(rs.next()){
               ...
               double Bal=0;
               Bal = rs.getDouble("accountBalance");
               int accty = rs.getInt("accountType");
               if(accty==2){
                    JOptionPane.showMessageDialog(this, "You cannot transfer to a loan account");
                    return;
               }
               
               sql = "UPDATE account SET accountBalance = ? WHERE accountID = ?";
               ps = MyConnection.getConnection().prepareStatement(sql);
               ps.setDouble(1, Bal+minusamount);
    ...
    private void tfTransferActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfTransferActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfTransferActionPerformed
